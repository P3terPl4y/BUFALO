...
// Empresa representa una organización que participa en el movimiento de cargas.
// OwnerID identifica al usuario que la registró; las relaciones operativas se
// mantienen mediante Choferes y las referencias de Carga.
type Empresa struct {
